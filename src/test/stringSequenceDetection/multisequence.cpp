...
BOOST_AUTO_TEST_CASE( MultiSequenceSingleFile )
{
	...
	// Use last number
	std::vector<sequenceParser::Sequence> listSequence_lastNumber = sequenceFromFilenameList( paths, (sequenceParser::eDetectionNegative) );
	...
	// Use first number
	std::vector<sequenceParser::Sequence> listSequence_firstNumber = sequenceFromFilenameList( paths, (sequenceParser::eDetectionNegative | sequenceParser::eDetectionSingleFileSeqUseFirstNumber) );
